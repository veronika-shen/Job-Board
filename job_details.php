...
$auth = isset($_SESSION['company_id']) ? 1 : 0;
...
$job = $pdo->query("SELECT jobs.*, employment.name AS employment_name,experience.name AS experience 
                            FROM jobs 
                            LEFT JOIN employment ON employment.id = jobs.employment_id
                            JOIN experience ON experience.id = jobs.experience_id
                            WHERE jobs.id = $id")->fetch(PDO::FETCH_ASSOC);
?>
                            ...
                            <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                                <div class="Appointment">
                                    ...
                                    <div class="d-none d-lg-block">
                                        <a class="boxed-btn3" href="/crud-vacancy/post_job.php">Post a Job</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="apply_job_form white-bg">
                        ...
                        <form action="apply-response.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <input name="website_link" type="text" placeholder="Website/Portfolio link">
                                    </div>
                                </div>
                                <div class="col-md-12">

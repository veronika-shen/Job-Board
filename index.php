            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="single_catagory">
                        <a href="jobs.php"><h4><?= $popularCategory['name']?></h4></a>
                        <p><span><?= $popularCategory['avialble_pos'] ?></span> Available position</p>
                    </div>
                </div>
            <?php endforeach;?>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="single_company">
                        ...
                        <a href="jobs.php"><h3><?= $company['name']?></h3></a>
                        <p> <span><?= $company['avialble_pos']?></span> Available position</p>
                    </div>
                </div>
<?php endforeach;?>
            </div>
